...
class AddVimeoVideoDialog extends StatefulWidget {
  const AddVimeoVideoDialog({super.key, this.courseId, this.playlistId});
  final int? courseId;
  final int? playlistId;

  @override
  State<AddVimeoVideoDialog> createState() => _AddVimeoVideoDialogState();
}

class _AddVimeoVideoDialogState extends State<AddVimeoVideoDialog> {
  late VimeoUploadController controller;
  late CourseModel courseModel;

  @override
  void initState() {
    super.initState();
    controller = Get.find<VimeoUploadController>();
