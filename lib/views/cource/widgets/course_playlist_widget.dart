        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Container(
              ...
              child: ExpansionTile(
                title: Text(
                  controller.playlists[index].title!,
                  style: TextStyle(
                ...
                subtitle: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        controller
                            .durationFromSeconds(totalPlayListVideosDuration)
                            .value,
                      ),
                    ],
                  ),
                ...
                children: List.generate(
                  ...
                  (generator) {
                    ...
                    if (RoleHelper.role == Role.full ||
                        !(controller.playlists[index].videos?[generator]
                                .isPaid! ??
                            false) ||
                        (controller.courseModel?.isSubscribed ?? false)) {
                      canPlay = true;
                    ...
                    final videoDuration = controller
                            .playlists[index].videos?[generator].duration ??
                        1; // مدة الفيديو
                    final watchedTime = LocalStorage.getVideoLastWatchedSecond(
                          controller.playlists[index].videos?[generator].id
                                  .toString() ??
                              '',
                        ) ??
